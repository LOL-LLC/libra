...
<pre><code><b>resource</b> <b>struct</b> <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>
</code></pre>
    ...
    move_to(vm, <a href="Oracle.md#0x1_Oracle_Oracles">Oracles</a> {
      upgrade: <a href="Oracle.md#0x1_Oracle_UpgradeOracle">UpgradeOracle</a> {
          ...
          consensus: <a href="Oracle.md#0x1_Oracle_VoteCount">VoteCount</a>{
            ...
            hash: <a href="Vector.md#0x1_Vector_empty">Vector::empty</a>&lt;u8&gt;(),
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_handler">handler</a> (sender: &signer, id: u64, data: vector&lt;u8&gt;) <b>acquires</b> <a href="Oracle.md#0x1_Oracle_Oracles">Oracles</a>, <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a> {
  ...
  <b>if</b> (id == 1) {
    <a href="Oracle.md#0x1_Oracle_upgrade_handler">upgrade_handler</a>(<a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender), <b>copy</b> data);
    <b>if</b> (<a href="Oracle.md#0x1_Oracle_DELEGATION_ENABLED_UPGRADE">DELEGATION_ENABLED_UPGRADE</a> && <b>exists</b>&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(<a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender))) {
      <b>let</b> del = borrow_global&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(<a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender));
      <b>let</b> l = <a href="Vector.md#0x1_Vector_length">Vector::length</a>&lt;address&gt;(&del.delegates);
      <b>let</b> i = 0;
      <b>let</b> hash = <a href="Hash.md#0x1_Hash_sha2_256">Hash::sha2_256</a>(data);
      <b>while</b> (i &lt; l) {
        <b>let</b> addr = *<a href="Vector.md#0x1_Vector_borrow">Vector::borrow</a>&lt;address&gt;(&del.delegates, i);
  ...
  <b>else</b> <b>if</b> (id == 2) {
    <a href="Oracle.md#0x1_Oracle_upgrade_handler_hash">upgrade_handler_hash</a>(<a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender), <b>copy</b> data);
    <b>if</b> (<a href="Oracle.md#0x1_Oracle_DELEGATION_ENABLED_UPGRADE">DELEGATION_ENABLED_UPGRADE</a> && <b>exists</b>&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(<a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender))) {
      <b>let</b> del = borrow_global&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(<a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender));
      <b>let</b> l = <a href="Vector.md#0x1_Vector_length">Vector::length</a>&lt;address&gt;(&del.delegates);
      <b>let</b> i = 0;
...
<pre><code><b>fun</b> <a href="Oracle.md#0x1_Oracle_upgrade_handler">upgrade_handler</a> (sender: address, data: vector&lt;u8&gt;) <b>acquires</b> <a href="Oracle.md#0x1_Oracle_Oracles">Oracles</a> {
  ...
  <b>if</b> (<a href="Vector.md#0x1_Vector_contains">Vector::contains</a>&lt;address&gt;(&upgrade_oracle.validators_voted, &sender)) {<b>return</b>};
  ...
  <b>let</b> validator_vote = <a href="Oracle.md#0x1_Oracle_Vote">Vote</a> {
          validator: sender,
          data: <a href="Hash.md#0x1_Hash_sha2_256">Hash::sha2_256</a>(<b>copy</b> data),
  ...
  <a href="Vector.md#0x1_Vector_push_back">Vector::push_back</a>(&<b>mut</b> upgrade_oracle.validators_voted, sender);
...
<pre><code><b>fun</b> <a href="Oracle.md#0x1_Oracle_increment_vote_count">increment_vote_count</a>(vote_counts: &<b>mut</b> vector&lt;<a href="Oracle.md#0x1_Oracle_VoteCount">VoteCount</a>&gt;, data: vector&lt;u8&gt;, validator: address, vote_weight: u64) {
  <b>let</b> data_hash = <a href="Hash.md#0x1_Hash_sha2_256">Hash::sha2_256</a>(<b>copy</b> data);
  <b>let</b> i = 0;
  ...
  <b>while</b> (i &lt; len) {
      ...
      <b>if</b> (<a href="Vector.md#0x1_Vector_compare">Vector::compare</a>(&entry.hash, &data_hash)) {
  ...
  <a href="Vector.md#0x1_Vector_push_back">Vector::push_back</a>(vote_counts, <a href="Oracle.md#0x1_Oracle_VoteCount">VoteCount</a>{data: <b>copy</b> data, hash: data_hash, validators: validators, total_weight: vote_weight});
}
</code></pre>
...
<pre><code><b>fun</b> <a href="Oracle.md#0x1_Oracle_increment_vote_count_hash">increment_vote_count_hash</a>(vote_counts: &<b>mut</b> vector&lt;<a href="Oracle.md#0x1_Oracle_VoteCount">VoteCount</a>&gt;, data: vector&lt;u8&gt;, validator: address, vote_weight: u64): bool {
  ...
  <b>while</b> (i &lt; len) {
      <b>let</b> entry = <a href="Vector.md#0x1_Vector_borrow_mut">Vector::borrow_mut</a>(vote_counts, i);
      <b>if</b> (<a href="Vector.md#0x1_Vector_compare">Vector::compare</a>(&entry.hash, &data)) {
        <a href="Vector.md#0x1_Vector_push_back">Vector::push_back</a>(&<b>mut</b> entry.validators, validator);
        entry.total_weight = entry.total_weight + vote_weight;
        <b>return</b> <b>true</b>
      };
...
<pre><code><b>fun</b> <a href="Oracle.md#0x1_Oracle_get_weight">get_weight</a> (voter: address, type: u8): u64 {
  ...
  <b>else</b> {
    <b>assert</b>(<b>false</b>, <a href="Errors.md#0x1_Errors_invalid_argument">Errors::invalid_argument</a>(<a href="Oracle.md#0x1_Oracle_VOTE_TYPE_INVALID">VOTE_TYPE_INVALID</a>));
    1
  }
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_enable_delegation">enable_delegation</a> (sender: &signer) {
  move_to&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(sender, <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>{
    ...
    delegates: <a href="Vector.md#0x1_Vector_empty">Vector::empty</a>&lt;address&gt;(),
    delegated_to_address: <a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender),
  });
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_check_number_delegates">check_number_delegates</a> (addr: address): u64 <b>acquires</b> <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a> {
  ...
  <a href="Vector.md#0x1_Vector_length">Vector::length</a>&lt;address&gt;(& del.delegates)
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_delegate_vote">delegate_vote</a> (sender: &signer, vote_dest: address) <b>acquires</b> <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>{
  <b>assert</b>(<b>exists</b>&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(<a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender)), <a href="Errors.md#0x1_Errors_not_published">Errors::not_published</a>(<a href="Oracle.md#0x1_Oracle_DELEGATION_NOT_ENABLED">DELEGATION_NOT_ENABLED</a>));
  <b>assert</b>(<b>exists</b>&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(vote_dest), <a href="Errors.md#0x1_Errors_not_published">Errors::not_published</a>(<a href="Oracle.md#0x1_Oracle_DELEGATION_NOT_ENABLED">DELEGATION_NOT_ENABLED</a>));

  <b>let</b> del = borrow_global_mut&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(<a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender));
  <b>assert</b>(del.vote_delegated == <b>false</b>, <a href="Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(<a href="Oracle.md#0x1_Oracle_VOTE_ALREADY_DELEGATED">VOTE_ALREADY_DELEGATED</a>));
  ...
  <a href="Vector.md#0x1_Vector_push_back">Vector::push_back</a>&lt;address&gt;(&<b>mut</b> del.delegates, <a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender));
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_remove_delegate_vote">remove_delegate_vote</a> (sender: &signer) <b>acquires</b> <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>{
  ...
  del.delegated_to_address = <a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender);
  ...
  <b>if</b> (<b>exists</b>&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(vote_dest)) {
    ...
    <b>let</b> (b, loc) = <a href="Vector.md#0x1_Vector_index_of">Vector::index_of</a>&lt;address&gt;(&del.delegates, &<a href="Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender));
    <b>if</b> (b) {
      <a href="Vector.md#0x1_Vector_remove">Vector::remove</a>&lt;address&gt;(&<b>mut</b> del.delegates, loc);
    };
  };
